...
function Dial({
  ...
  return (
    ...
    >
      {/* One ring leaves the centre as the hero settles, then never again.
          It is the gesture from the app's scan screen, which is where the
          product's story starts: the remote looking for the television. */}
